...
<article style="position:absolute;left:-9999px;width:1px;height:1px;overflow:hidden">
    ...
    <p>Jeu bonus Virealys: un divertissement de fidelisation qui presente les zones, les recettes, le passeport numerique et les recompenses fictives utilisables au restaurant.</p>
    ...
    <h2>Profondeur de jeu</h2><p>Inventaire, aura, tension de service, recettes a maitriser, upgrades de brigade, equipage recrutable, astres de constellation, soirees successives et saisons donnent une progression persistante sans remplacer le site restaurant.</p>
