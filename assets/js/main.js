...
(function () {
    ...
    function initRadialMenu() {
        ...
        var allPages = [
            ...
            { slug: 'partenariat-holazyv', label: 'HoLazyV', icon: 'link', color: '#7dd3c7' },
    ...
    function getRadialIcon(name) {
        var icons = {
            ...
            link: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M10 13a5 5 0 0 0 7.07 0l2.12-2.12a5 5 0 0 0-7.07-7.07l-1.21 1.21"/><path d="M14 11a5 5 0 0 0-7.07 0L4.81 13.12a5 5 0 0 0 7.07 7.07l1.21-1.21"/></svg>',
